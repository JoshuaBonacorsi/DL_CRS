...
class ExplicitDLCRS(nn.Module):

    def __init__(self,
                 n_users, # liste des users id
                 n_movies, # liste des movies id
                 n_latents, # nombre de latents factors 
                 n_layers, # nombre de couches dans la partie fully connected
                 dropout=None): # taux de dropout
        ...
        # Output layer part
        self.fc_layers.append(nn.Linear(50,1))
